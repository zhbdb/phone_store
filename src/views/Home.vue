...
<script>
    ...
    export default {
        ...
        created() {
            const _this = this
            axios.get('http://localhost:8081/phone/index').then(function (response) {
        ...
        methods: {
            onClick(index) {
                const _this = this
                axios.get('http://localhost:8081/phone/findByCategoryType/'+this.categories[index].type).then(function (response) {
            ...
            buy(index) {
                this.show = true
                const _this = this
                axios.get('http://localhost:8081/phone/findSpecsByPhoneId/'+this.phones[index].id).then(function (response) {
